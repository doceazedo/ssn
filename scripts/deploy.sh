...
$DOCKER system prune -af --volumes &&
$DOCKER compose -f docker-compose.prod.yml up --build -d minecraft-proxy &&
$DOCKER system prune -af --volumes &&
$DOCKER compose -f docker-compose.prod.yml up --build -d minecraft-queue &&
$DOCKER system prune -af --volumes &&
$DOCKER compose -f docker-compose.prod.yml up --build -d minecraft-main &&
$DOCKER system prune -af --volumes &&
