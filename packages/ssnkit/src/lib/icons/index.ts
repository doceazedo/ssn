...
export { default as HandCoinsIcon } from "./hand-coins-icon.svelte";
...
export { default as MegaphoneIcon } from "./megaphone-icon.svelte";
export { default as PiggyBankIcon } from "./piggy-bank-icon.svelte";
