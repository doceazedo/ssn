...
<svg
	...
	class={className}
	><g fill="none"
		><g clip-path="url(#flagpackBr3)"
			><path fill="#093" fill-rule="evenodd" d="M0 0v24h32V0z" clip-rule="evenodd" /><mask
				id="flagpackBr0"
				width="32"
				height="24"
				x="0"
				...
				><path fill="#fff" fill-rule="evenodd" d="M0 0v24h32V0z" clip-rule="evenodd" /></mask
			><g mask="url(#flagpackBr0)"
				><g fill-rule="evenodd" clip-rule="evenodd" filter="url(#flagpackBr4)"
					><path fill="#FFD221" d="m15.927 3.704l12.202 8.504L15.76 20.17L3.809 12.043z" /><path
		...
		><defs
			><linearGradient
				...
				><stop stop-color="#FFC600" /><stop offset="1" stop-color="#FFDE42" /></linearGradient
			><clipPath id="flagpackBr3"><path fill="#fff" d="M0 0h32v24H0z" /></clipPath><filter
				id="flagpackBr4"
				width="24.32"
				height="16.467"
				x="3.809"
				...
				/><feBlend in2="BackgroundImageFix" result="effect1_dropShadow_270_67334" /><feBlend
					in="SourceGraphic"
